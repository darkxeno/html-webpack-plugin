...
var ldtemplate = require('lodash/template');
var lddefaults = require('lodash/defaults');
...
module.exports = function (source) {
  ...
  var template = ldtemplate(source, lddefaults(options, { variable: 'data' }));
  ...
  var result = 'module.exports = function (templateParams) {' +
